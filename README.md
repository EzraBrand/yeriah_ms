...
The opening folios illustrate this method especially well. The upper pool and the four rivers of Eden are coordinated with the upper sefirot; the Trees of Life and Knowledge are interpreted through Israel, Jacob, Esau, Michael, and Samael; Adam and Eve, Jacob’s thigh, the serpent, the Golden Calf, and the positive and negative commandments become parts of a single relational map. The commentary repeatedly organizes this material through paired structures: right and left, mercy and judgment, masculine and feminine, upper and lower, holy power and its opposing counterpart. These are not merely narrative allegories. They are coordinates within a diagram of emanation, conflict, and transmission.

The manuscript’s vocabulary preserves older kabbalistic nomenclature. *Pachad* (“Fear”), often abbreviated in the manuscript as `הפח׳`, is a name for the sefirah more commonly called *Gevurah* (“Power” or “Severity”); *Gedulah* (“Greatness”) similarly names *Chesed* (“Mercy” or “Lovingkindness”). Other sefirotic names appear in abbreviated or punctuated forms, including `חכמ״ה`, `בינ״ה`, `גבור״ה`, `תפאר״ת`, `נצ״ח`, `הו״ד`, and `יסו״ד`. The word `הויה` can denote not merely “being” in the abstract but a hypostasis or emanated divine grade. Such terms are translated consistently but retained in transliteration where an English equivalent would conceal their technical force.

The copyist assumes a reader comfortable with highly compressed scholarly notation. Punctuation is sparse; a biblical phrase may merge directly into its explanation; abbreviations may carry much of the argument; and a lemma can be indicated by rubrication or an overline rather than by a clean break in the sentence. Interlinear additions, deletions, marginal matter, and occasional damage or photographic blur complicate the reading further. The translation therefore preserves uncertainty instead of silently smoothing it away. It follows the JTS lineation, presents its Hebrew and English side by side, and places the corresponding Oxford passage before each major lemma. Oxford and Busi help recover the underlying *Iggeret Sippurim*, but variants are reported rather than silently substituted for the wording transmitted in the commentary manuscript.
